const BLOG = {
  title: 'AI News by OSEN',
  author: 'OSEN',
  email: '',
  link: 'https://ai.osen.design',
  newsletter: 'AINews Dayly',
  description: 'Save your times and All in AI',
  lang: 'en-US', // ['en-US', 'zh-CN', 'zh-HK', 'zh-TW', 'ja-JP', 'es-ES']
  timezone: 'Asia/Shanghai', // See https://en.wikipedia.org/wiki/List_of_tz_database_time_zones for all options.
  appearance: 'light', // ['light', 'dark', 'auto'],
  font: 'sans-serif', // ['sans-serif', 'serif']
  lightBackground: '#FFFFFF', // use hex value, don't forget '#' e.g #fffefc
  darkBackground: '#111111', // use hex value, don't forget '#'
  ...
  socialLink: {
    twitter: 'https://twitter.com/osen77',
    github: 'https://github.com/arkuus',
  },
  seo: {
    keywords: ['AIGC 每日消息', 'AI新闻', 'AI资讯', 'AI News', '人工智能新闻', 'AI Information', 'AI', 'OSEN'],
    googleSiteVerification: '' // Remove the value or replace it with your own google site verification code
  },
  notionPageId: process.env.NOTION_PAGE_ID, // DO NOT CHANGE THIS! Edit .env file!
  notionSpacesId: process.env.NOTION_SPACES_ID, // DO NOT CHANGE THIS! Edit .env file!
  notionAccessToken: process.env.NOTION_ACCESS_TOKEN, // Useful if you prefer not to make your database public
  notionDomain: 'ooosen.notion.site',
